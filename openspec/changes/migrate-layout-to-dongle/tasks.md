...
- [ ] 5.2 Закоммитить и отправить рабочую ветку, дождаться успешной GitHub Actions сборки всех четырёх targets и проверить содержимое датированного artifact.
- [ ] 5.3 Зафиксировать номера run/jobs и автоматические результаты в test matrix, повторить статические/OpenSpec проверки и отметить все реально завершённые tasks.
